        ...
        let source = svg.append('g')
            ...
            .attr('fill', function (d, i) {
                ...
                if (genderMale === 0)
                    ...
                    // let limit_5 = Math.ceil(limit / 5) * 5;
            ...
            .on("mousemove", function (d) {
                let html = "";
                state_details = stateCountsData[stateName];
                html += "<div class=\"tooltip_kv\">";
                html += "<span class=\"tooltip_key\">";
                html += d['id'] + ", " + state_details.code;
                html += "</span>";
                html += "<span class=\"tooltip_value\">Total Deaths: ";
                html += d['count'];
                html += "";
                html += "</span>";
                html += "</div>";
                html += '<div>';
                html += '<span class=\"subtext\"><span class=\"red\">Female</span> Deaths: ';
                html += d['genderFemale'];
                html += "</span><br/>";
                html += '<span class=\"subtext\"><span class=\"blue\">Male</span> Deaths: ';
                html += d['genderMale'];
                html += "</span><br/>";
                html += "</div>";
...
function bubbleClicked(d, stateName) {
    ...
    d3.select('span.location-text').text(city + ', ' + stateName);
